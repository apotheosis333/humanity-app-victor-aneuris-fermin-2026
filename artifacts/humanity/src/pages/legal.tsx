...
const pageCopy = {
  ...
  support: {
    ...
    body: [
      ...
      "The final founder-approved support email or support form URL still needs to be added before store submission. Until then, this page is a launch-prep placeholder and should not be treated as a final support channel.",
  ...
  dataDeletion: {
    ...
    body: [
      ...
      "If you cannot access your account, use the Support page. A final support email or support form URL must be added before store submission.",
      "HuMANity does not currently promise instant or automated deletion. The final deletion timeline, retention rules, and verification process need owner/legal confirmation before launch.",
    ],
